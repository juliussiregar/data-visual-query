...
export function WidgetEditShell({
  ...
  return (
    <div
      id={`widget-${widget.id}`}
      className="overflow-hidden rounded-2xl ring-1 ring-indigo-500/25 ring-offset-1 ring-offset-slate-950"
    >
      <div className="flex flex-wrap items-center justify-between gap-2 bg-indigo-500/[0.07] px-3 py-2 sm:px-4">
        <span className="text-[11px] font-medium uppercase tracking-wide text-indigo-300/90">
        ...
        <div className="flex flex-wrap gap-1.5">
          ...
          <button
            type="button"
            onClick={onHide}
            className="flex items-center gap-1.5 rounded-lg bg-red-500/10 px-3 py-1.5 text-[11px] font-medium text-red-300 ring-1 ring-red-500/20 hover:bg-red-500/20"
          >
...
function ChartWidgetSettings({
  ...
  return (
    <div className="border-b border-white/10 bg-slate-950/60 px-4 py-4">
      <p className="mb-3 text-xs text-slate-400">Sesuaikan bentuk dan sumber data grafik</p>
      <div className="grid gap-3 sm:grid-cols-2">
        <label className="block">
          <span className="mb-1.5 block text-xs font-medium text-slate-300">Bentuk grafik</span>
          <select
        ...
        <label className="block">
          <span className="mb-1.5 block text-xs font-medium text-slate-300">Kelompokkan berdasarkan</span>
          <select
        ...
        <label className="block">
          <span className="mb-1.5 block text-xs font-medium text-slate-300">Nilai angka</span>
          <select
        ...
        <label className="block">
          <span className="mb-1.5 block text-xs font-medium text-slate-300">Cara hitung</span>
          <select
